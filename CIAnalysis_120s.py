...
It supports two types of cells:
    ...
    2. DOWC - Uses `individual_dFoverF0_DOWC.py` for analysis. F0=Fmin(the lowest fluorescence in first 120s)
...
Usage:
    python CIAnalysis_120s.py -i <project_dir> [-t <number of position t>] [-b <background_file>] [--merge] [--cell_type DOCC/DOWC] [--help]
